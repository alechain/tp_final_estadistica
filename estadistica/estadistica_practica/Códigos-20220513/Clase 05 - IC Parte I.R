...
## Para traer sript con funciones
source('funciones.r')
library(pastecs)
...
pastecs::stat.desc(lizard, norm=TRUE)

Histogram(lizard,density = TRUE)
...
set.seed(1234)
Histogram(chowPopulation)
Histogram(Bodyweight,data = datos,density = TRUE)
...
# Sin embargo, podemos tomar otra muestra y 
# es posible que no tengamos tanta suerte. 
# De hecho, la teor?a nos dice que cubriremos el 95% del tiempo. 
...
## Tama?o de muestra peque?o y el TCL
## Para N = 30, el TCL funciona muy bien. 
## Sin embargo, si N = 5, 
